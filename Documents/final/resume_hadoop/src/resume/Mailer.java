...
public static int EmailSending(String To, String Sub, String Msg) {
            ...
            session = Session.getDefaultInstance(props,
                    new javax.mail.Authenticator() {
                        ...
                        protected PasswordAuthentication getPasswordAuthentication() {
                            return new PasswordAuthentication("pramodjavatest@gmail.com","javatest");
                        }
                    });
        
            String From = "pramodjavatest@gmail.com";
    ...
    public static void main(String[] args) {
        ...
        //s.EmailSending("sandesh.srccode@gmail.com", "Test1", "Test1");
