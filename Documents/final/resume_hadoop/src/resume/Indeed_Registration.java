 ...
 * @author HAPPY
 */
public class Indeed_Registration extends javax.swing.JFrame {
    ...
    private void SubmitAction(java.awt.event.ActionEvent evt) {                              
        ...
        try {
           				...
           				String td=formatter.format(d);
                                stmt = cn.prepareStatement("INSERT INTO `reg` (`uid`, `name`, `email`, `mn`, `nationality`, `add`, `uname`, `pass`,`resume`,`from`,`date_upload`,`flag`) "
                    + "VALUES (NULL, '"+Name+"', '"+Email+"', '"+Mn+"', '"+Nationality+"','"+Address+"', '"+Uname+"', '"+Pass+"', '"+fname+"', '"+from+"','"+td+"','"+0+"')");
                         stmt.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Indeed_Registration().setVisible(true);
            }
        });
    }
